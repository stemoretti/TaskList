#!/usr/bin/env bash
#
# Android release apk/aab build script
#
...
mv $build_dir/android-build/tasklist.apk tasklist_${VERSION}.apk
mv $build_dir/android-build/build/outputs/bundle/release/android-build-release.aab tasklist_${VERSION}.aab
